...
mod vault_fcn {
  ...
  fn test_smol_management_fee() {
    ...
    vault.apply_management_fee(vault_equity, now + ONE_YEAR as i64).unwrap();
    assert_eq!(vault.user_shares, 100000000);
  ...
  fn test_negative_management_fee() {
    ...
    vault.apply_management_fee(vault_equity, now + 1_i64).unwrap();
    assert_eq!(vault.user_shares, 100000000);
    ...
    vault.apply_management_fee(vault_equity, now + 60_i64).unwrap();
    assert_eq!(vault.user_shares, 100000000);
