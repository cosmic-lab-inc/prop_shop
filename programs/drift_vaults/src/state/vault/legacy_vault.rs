...
impl VaultTrait for Vault {
  ...
  fn protocol_request_withdraw(&mut self, _: u64, _: WithdrawUnit, _: u64, _: i64) -> Result<()> {
    Ok(())
  }

  fn protocol_cancel_withdraw_request(&mut self, _: u64, _: i64) -> Result<()> {
    Ok(())
  }

  fn protocol_withdraw(&mut self, _: u64, _: i64) -> Result<u64> {
    Ok(0)
  }
