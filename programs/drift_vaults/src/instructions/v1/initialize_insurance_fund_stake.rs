...
use crate::{declare_vault_seeds, VaultTrait, VaultV1};
use crate::drift_cpi::InitializeInsuranceFundStakeCPI;
use crate::v1_constraints::{is_manager_for_vault, is_spot_market_for_vault, is_user_stats_for_vault};

pub fn initialize_insurance_fund_stake_v1<'info>(
  ctx: Context<'_, '_, '_, 'info, InitializeInsuranceFundStakeV1<'info>>,
  market_index: u16,
) -> Result<()> {
...
pub struct InitializeInsuranceFundStakeV1<'info> {
  #[account(mut,
