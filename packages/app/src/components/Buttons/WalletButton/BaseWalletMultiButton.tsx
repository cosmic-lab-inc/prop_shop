...
import {ButtonProps, ListItem, ListItemButton, ListItemIcon, ListItemText, styled, Typography,} from '@mui/material';
        ...
        {menuOpen && (
          <List>
            ...
            <ListEntry
              ...
              text={<Typography variant="body1">{prettyNumber(client?.sol ?? 0)}</Typography>}
            />

            <ListEntry
              icon={<UsdcIcon size={30}/>}
              text={
                <Typography variant="body1">${prettyNumber(client?.usdc ?? 0)}</Typography>
              }
            />
